...
func InitTableMap() {
	/*
	   db.AccountDBMap.AddTableWithName(Accountsinfo{}, "accountsinfo").SetKeys(false,"UserID")
	   ...
	   db.AccountDBMap.AddTableWithName(Commission{}, "commission").SetKeys(true, "OnLineId")
	   db.AccountDBMap.AddTableWithName(CommissionCopy{}, "commission_copy").SetKeys(true, "OnLineId")
