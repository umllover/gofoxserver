...
func LoadBaseData() {
	...
	BackendGoodsCache.LoadAll()
	ConGoodsCache.LoadAll()
	...
	db.BaseDataCaches["BackendGoods"] = BackendGoodsCache
	db.BaseDataCaches["ConGoods"] = ConGoodsCache
	...
	log.Debug("loadBaseData %v  %v %v", 14, time.Now().UnixNano()-start, "ns")
}
