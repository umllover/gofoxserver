...
func (op *userextrainfoOp) QueryByMapQueryByMapComparison(m map[string]interface{}) ([]*Userextrainfo, error) {
	result := []*Userextrainfo{}
	var params []interface{}
...
// 返回符合查询条件的记录数
func (op *userextrainfoOp) CountByMap(m map[string]interface{}) int64 {
