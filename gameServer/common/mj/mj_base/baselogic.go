...
//
func (lg *BaseLogic) AddKindItem(KindItem []*TagKindItem, KindType int, Index int, MagicIndex int, count int) []*TagKindItem {
	tg := &TagKindItem{CardIndex: make([]int, 4)}
	tg.CenterCard = Index
	for t := 0; t <= 2; t++ {
		if count > t {
