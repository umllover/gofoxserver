...
func InitTableMap() {
	/*
	   ...
	   db.DBMap.AddTableWithName(RecordOutcardDdz{}, "record_outcard_ddz").SetKeys(true, "RecordID")
	   db.DBMap.AddTableWithName(RecordOutcardDdzKing{}, "record_outcard_ddz_king").SetKeys(true, "RecordID")
	   db.DBMap.AddTableWithName(RoomId{}, "room_id").SetKeys(false,"Id")
	   db.DBMap.AddTableWithName(RoomRecord{}, "room_record").SetKeys(true, "RecordId")
	   ...
	   db.DBMap.AddTableWithName(UserRoomRecord{}, "user_room_record").SetKeys(false,"UserId","RecordId")
